...
emp2 = Empleado('Maria Lopez', 22, 'M', True)
print(emp2)

emp3 = Empleado('Rosario Valenzuela', 15, 'M', False)
print(emp3)
...
if (emp2.casado==False and emp4.casado==False):
    print(f"\n {emp2.nombre} se puede casar con {emp4.nombre} ambos se pueden casar")

if (emp1.casado==True and emp3.casado==True):
    print(f"\n {emp1.nombre} no se puede casar con {emp3.nombre} ambos estan casados")
